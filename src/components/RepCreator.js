    ...
    return(
        <div className="dark">
            ...
            <div>
                ...
                <div className="bandoValider">
                    <input type="button" className="ButtonStyle" value='Go =>' onClick={()=>{alert('En cours de développement. La fonctionalité sera bientôt disponible!')}}/>                  
                </div>
            </div>
        </div>
    )
