...
class Rco extends React.Component{
    ...
    render(){
        return (
            <div className="tdpHead Creator" style={{maxWidth:"220px"}}>{'Rco: '+(this.props.number+1)}
                <div>
                    <div className="input-group input-group-sm ">
                        <div className="input-group-prepend">
                            <div className="input-group-text" id="btnGroupAddon">Nombre de colonne :</div>
                        </div>
                            <input type="number" className="form-control col-sm-1" style={{maxWidth:"40px"}} defaultValue={this.fermeNumber} onChange={this.nbFerme_handleChange} aria-describedby="btnGroupAddon"/>
                    </div>                        
                </div>
            </div>
        )
